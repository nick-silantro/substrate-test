...
Sources: engine flat files (_system/docs/*.md with frontmatter) + workspace entities (context-doc type).
...
def load_all_docs():
    """Load context docs from both engine flat files and workspace entities."""
    return load_engine_docs() + load_entity_docs()
